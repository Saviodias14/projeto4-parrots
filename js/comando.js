...
function fimDoJogo(){
    clearInterval(cron);
    alert(`Você ganhou em ${numeroDeJogadas} jogadas! A duração do jogo foi de ${contagem(Number(minutoTempo))}:${contagem(Number(segundoTempo))} segundos!`);
...
function iniciaTimer(){
    ...
    segundoTempo = contagem(Number(segundoTempo));
    minutoTempo = contagem(Number(minutoTempo));
    segundo.innerHTML = segundoTempo;
    minuto.innerHTML = minutoTempo;
}
